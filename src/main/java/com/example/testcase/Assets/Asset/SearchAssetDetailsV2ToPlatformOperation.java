...
public class SearchAssetDetailsV2ToPlatformOperation extends Base {
    ...
    public void GET_assets_details(){
        String url =  envHost+"assetRepo/v2/assets?assetId="+ ProcessData.assetidforsearch;
